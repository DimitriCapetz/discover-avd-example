...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- |
| 10.3.0.41 | 65316 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
...
router bgp 65300
   ...
   neighbor 10.3.0.41 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.3.0.41 remote-as 65316
   neighbor 10.3.0.41 description DC3-BORDER1_Ethernet49/1
   neighbor 10.3.0.45 peer group IPv4-UNDERLAY-PEERS
